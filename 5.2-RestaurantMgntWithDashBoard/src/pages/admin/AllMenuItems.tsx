...
import { Clipboard, Edit, Trash2, Plus, X, SaveIcon, XCircle } from 'lucide-react'
...
const AllMenuItems: React.FC = () => {
    ...
    const { data: allMenuItem, isLoading: menuIsLoading, isError: menuIsError } = menuItemApi.useGetAllMenuItemsQuery(
        ...
        <AdminDashboardLayout>
            ...
            ? (
                ...
                <div className="bg-red-50 border border-red-200 rounded-lg p-6 text-center">
                    ...
                    <h3 className="text-lg font-semibold text-red-800 mb-2">Error Loading Menu Items</h3>
                    <p className="text-red-600">Unable to fetch menu items. Please try again later.</p>
                </div>

...
import { DollarSign, HardDriveDownload, Heart, ShoppingCart, Star, User, XCircle } from 'lucide-react'
...
const UserDashboard: React.FC = () => {
    ...
    return (
        <DashboardLayout>
            {/* Welcome Header */}
            <div className="mb-8">
                <div className="bg-linear-to-r from-green-800 to-green-600 rounded-lg p-6 text-white">
                    <h1 className="text-3xl font-bold">Welcome back, {user?.first_name || 'Valued Customer'}! 👋</h1>
                    <p className="mt-2 text-green-100">Here's your dining journey with Mathe's Eatery</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                {userStatsLoading ? (
                    ...
                    <div className="bg-red-50 border border-red-200 rounded-lg p-6 text-center">
                        ...
                        <p className="text-red-600">Unable to fetch your dashboard data. Please try again later.</p>
                    </div>
                ) : (
                    <>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
                <div className="flex items-center justify-between mb-6">
                    ...
                    <Link to="/menu" className="btn  btn-outline border-green-800 text-green-800 hover:bg-green-800 hover:text-white">
                        Browse Menu
                    </Link>
                </div>
